...
import { onlySellerAuthDashboards } from "@/app/const/permissions";
...
const ProfileClient = (props:{
  ...
  const handleInputChange = (field: string, fieldValue: any) => {
    if (field == 'image') {
      setData({ ...data, [field]: fieldValue,['isChange']:true });
      return;
    }
    const value = fieldValue.target.value;
    setData({ ...data, [field]: value,['isChange']:true });
  }
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              ...
              <Avatar src={data.image} size={500}/>
                {/* <Image
                ...
                >
                  ...
                  <ImageUpload
                  onlyIcon
                      value={props.currentUser?.image || defaultImage}
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">{props.currentUser?.role}</p>

             { onlySellerAuthDashboards.includes(props.currentUser?.role || "")&&
            ...
            {data.isChange &&
              <div className="mt-10">
              <button className="flex w-full justify-center rounded bg-primary p-3 font-medium text-gray hover:bg-opacity-90" onClick={onSubmit}>
                          Apply changes
                        </button>
              </div>
            }
