                ...
                <div className="flex flex-col-reverse gap-5 xl:flex-row xl:justify-between">
                  <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
                    <div>
                      ...
                      <a href="#" className="block"><span className="font-medium">Email:</span>
                        contact@example.com</a>
                      <span className="mt-2 block"><span className="font-medium">Address:</span> 2972
                    ...
                    <div>
                      ...
                      <a href="#" className="block"><span className="font-medium">Email:</span>
                        contact@example.com</a>
                      <span className="mt-2 block"><span className="font-medium">Address:</span> New York, USA
                        2707 Davis Anenue
                      </span>
                    </div>
                  </div>
                ...
                <div className="my-10 rounded-sm border border-stroke p-5 dark:border-strokedark">
                  <div className="items-center sm:flex">
                    <div className="mb-3 mr-6 h-20 w-20 sm:mb-0">
                      <img src="/images/product/product-thumb.png" alt="product" className="h-full w-full rounded-sm object-cover object-center"/>
                    </div>
                    <div className="w-full items-center justify-between md:flex">
                      <div className="mb-3 md:mb-0">
                        <a href="#" className="inline-block font-medium text-black hover:text-primary dark:text-white">
                          Mist Black Triblend
                        </a>
