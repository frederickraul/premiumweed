...
const UserInfoModal = (props:{open:boolean, onClose:any, data:any,onSubmit:any}) => {
                        ...
                        <div>
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                    <div className='relative w-20'>
                                        ...
                                        <Avatar classname='bg-red-500' src={user?.image || defaultImage}/>
                                        </div>
                                        <label
                                            htmlFor="profile"
                            ...
                            <div className="mt-7 mb-6">
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                    <div className="col-span-2 lg:col-span-1">
                                        <FormLabel text='Name'/>
                                        <FormInput type='text' value={user?.name} onChange={(value:any)=>{
                                    ...
                                    <div className="col-span-2 lg:col-span-1">
                                        ...
                                        <FormInput type='text' value={user?.lastname} onChange={(value:any)=>{
                                    ...
                                    <FormInput readonly type='email' value={user?.email} onChange={(value:any)=>{
