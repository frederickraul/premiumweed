...
const UserStatusModal = (props:{open:boolean,onClose:any,data:any, onSubmit:any}) => {
  ...
  <div className="no-scrollbar relative flex w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
    ...
    <div className="custom-scrollbar h-auto overflow-y-auto px-2">
          <div className='mb-5'>
            ...
            <ToggleSwitch id={0} active={user?.enable} 
            onChange={()=>{
              const value =user?.enable; 
              handleInputChange('enable',!value);
            }}/>
            </div>
          </div>
      ...
      <div className="flex items-center gap-3 mt-6 lg:justify-end">
        ...
        <button onClick={handleSubmit} type="button" className="flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto">
          Save Changes
        </button>
      </div>
    </form>
