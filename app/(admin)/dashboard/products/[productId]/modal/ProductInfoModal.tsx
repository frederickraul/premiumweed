...
const ProductInfoModal = (props:{open:boolean, onClose:any, data:any,onSubmit:any}) => {
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                    <div className='relative w-20'>
                                        ...
                                        >
                                            ...
                                            <ImageUpload
                                                onlyIcon
                                                value={product?.coverSrc || defaultProductImage}
                                                onChange={(value: any) => handleInputChange('coverSrc', value)}
                                            />
                                        </label>
                            ...
                            <div className="mt-7 mb-6">
                                ...
                                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                    <div className="col-span-2 lg:col-span-1">
                                        ...
                                        <FormInput type='text' value={product?.title} onChange={(value:any)=>{
                                    ...
                                    <div className="col-span-2 lg:col-span-1">
                                       ...
                                       <FormSelect list={categoryList} value={product?.category} onChange={(value:string)=>{
                                    ...
                                    <FormInput type='text' value={product?.description} onChange={(value:any)=>{
